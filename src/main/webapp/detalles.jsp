        ...
        <tr>
            ...
            <td contenteditable>
                <select name="idGenero">
                    ...
                    %>
                    <option value="<%=genero.getIdGenero()%>" <%if(movie.getIdGenero() == genero.getIdGenero()) {%>selected <%}%>> <%=genero.getNombre()%> </option>
                    <%
                        }
                    %>
                </select>
        ...
        <tr>
            ...
            <td contenteditable>
                <select name="idStreaming">
                    ...
                    %>
                    <option value="<%=streaming.getIdStreaming()%>" <%if(movie.getIdStreaming()==streaming.getIdStreaming()){%>selected <%}%>> <%=streaming.getNombreServicio()%> </option>
                    <%
                        }
                    %>
                </select>
